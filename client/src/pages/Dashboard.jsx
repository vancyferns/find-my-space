...
function Dashboard({ parkingSpots, locations }) {
...
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Available Parking Spots</h2>
      <div className="flex items-center gap-3 mb-6 p-4 bg-gray-50 rounded-lg">
        <label htmlFor="location-select" className="font-semibold text-gray-700 whitespace-nowrap">Filter by Location:</label>
        <select
          id="location-select"
